...
public class ReciboSerasa2 {
	...
	public static void main(String[] args) {
      ...
      String memoria = Integer.parseInt(quinzena) > 2?"  CONTAGEM REFERENTE AO TOTAL DAS QUINZENAS\n": "     CONTAGEM REFERENTE À "+quinzena+"ª QUINZENA\n";
